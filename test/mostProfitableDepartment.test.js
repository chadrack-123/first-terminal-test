...
import mostProfitableDepartment, { mostProfitableDay } from "../mostProfitableDepartment.js"
import chalk from "chalk"

describe (chalk.bgGreen.whiteBright("The mostProfitableDepartment function classifies sales performance :"), function() {
    it(chalk.bgWhiteBright.black("The mostProfitableDepartment loops through the objects & computes to return the most profitable Departments"), function () {
        var salesData = [
    ...
    it(chalk.bgWhiteBright.black("The mostProfitableDepartment loops through the objects & computes to return the most profitable Days"), function() {
        var salesData = [
            {department : 'hardware', sales : 4500, day : 'Monday'},
            {department : 'outdoor', sales : 1500, day : 'Monday'},
            {department : 'carpentry', sales : 5500, day : 'Monday'},
